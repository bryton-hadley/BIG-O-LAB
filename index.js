...
// ANSWER: O(1) as well becasue the space determined is fixed
...
// ANSWER: O(1) because it is trying to find the forth index

// Q: Given an array of numbers, what is the space complexity of this function?
// ANSWER: O(1) because it is still a fixed index of 4
...
// ANSWER: No. because in this for-loop the code is preventing it from exceeding past 4 run-throughs
...
// ANSWER: O(1) it has a set length 

// Q: What is the space complexity of this function?
// ANSWER: O(1) because it has afixed amount of data 
...
// Q: What is the time complexity of the function?
// ANSWER: O(1) because the only possible outcome is to push it on to the end of the array 
...
// ANSWER: yes becasue they are doing they samething 
...
// ANSWER: Each Fucntion is dependent on hte size of the string 
